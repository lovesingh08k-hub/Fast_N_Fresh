...
const { listTables, getTable, createTable, updateTable, deleteTable, clearTableOrders, getTableQr } = require('../controllers/tableController');
...
router.delete('/:id/orders', clearTableOrders);
