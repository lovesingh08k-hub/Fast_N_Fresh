...
class _DashboardScreenState extends State<DashboardScreen> with WidgetsBindingObserver {
      ...
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton<AppThemeMode>(
            ...
            onSelected: (mode) => changeThemeWithReveal(context, mode, originContext: context),
            itemBuilder: (_) => const [
  ...
  Widget _buildQuickActions() {
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(child: _quickAction(Icons.point_of_sale_outlined, 'New Sale', const NewOrderScreen())),
            const SizedBox(width: 10),
            Expanded(child: _quickAction(Icons.table_restaurant_outlined, 'Tables', const TablesScreen())),
          ],
        ),
      ],
    );
  ...
  Widget _quickAction(IconData icon, String label, Widget page) {
    return InkWell(
      ...
      child: Container(
        ...
        child: Column(children: [Icon(icon, color: AppColors.primary, size: 24), const SizedBox(height: 7), Text(label, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 12))]),
      ),
    );
  }
